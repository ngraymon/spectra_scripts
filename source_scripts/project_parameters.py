...
parent_project = "2022_tamp_testing"
# new models
...
# user_root = abspath("/$USER/projects/mctdh_compare")
user_root = abspath("/$USER/projects")
...
work_root = abspath(f"/work/{user_root}/{parent_project}/{project_name}/")
